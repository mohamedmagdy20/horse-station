<header id="masthead" itemscope="itemscope" itemtype="https://schema.org/WPHeader" dir="{{app()->getLocale() === 'ar' ? 'rtl' : 'ltr'}}">
    <p class="main-title bhf-hidden" itemprop="headline"><a href="{{route('home')}}" title="Horse Station"
            rel="home">Horse Station</a></p>
    <div data-elementor-type="wp-post" data-elementor-id="2639" class="elementor elementor-2639"
        ...
        <section style="background-color: #c1a872"
            class="elementor-section elementor-top-section elementor-element elementor-element-c0f18ba elementor-section-full_width elementor-section-content-middle elementor-section-height-default elementor-section-height-default rt-parallax-bg-no"
            data-id="c0f18ba" data-element_type="section"
            data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
            <div class="elementor-container elementor-column-gap-default">
                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-47db490"
                    data-id="47db490" data-element_type="column">
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-4f49e6f elementor-widget__width-auto elementor-shape-rounded elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons"
                            data-id="4f49e6f" data-element_type="widget"
                            data-widget_type="social-icons.default">
                            <div class="elementor-widget-container">
                                <div class="elementor-social-icons-wrapper elementor-grid">
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon-facebook elementor-repeater-item-58f42bd"
                                            target="_blank">
                                            <span class="elementor-screen-only">Facebook</span>
                                            <i class="fab fa-facebook"></i> </a>
                                    </span>
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-repeater-item-b8c9eba"
                                            target="_blank">
                                            <span class="elementor-screen-only">Instagram</span>
                                            <i class="fab fa-instagram"></i> </a>
                                    </span>
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon-whatsapp elementor-repeater-item-afd2bc0"
                                            target="_blank">
                                            <span class="elementor-screen-only">Whatsapp</span>
                                            <i class="fab fa-whatsapp"></i> </a>
                                    </span>
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon- elementor-repeater-item-a6730d6"
                                            target="_blank">
                                    ...
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon-snapchat-ghost elementor-repeater-item-af35429"
                                            target="_blank">
                                            <span class="elementor-screen-only">Snapchat-ghost</span>
                                            <i class="fab fa-snapchat-ghost"></i> </a>
                                    </span>
                                    <span class="elementor-grid-item">
                                        <a class="elementor-icon elementor-social-icon elementor-social-icon-tiktok elementor-repeater-item-10d228f"
                                            target="_blank">
                ...
                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-2be6045"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        ...
                        <div class="elementor-element elementor-element-df41a2a elementor-widget__width-auto elementor-widget elementor-widget-heading"
                            ...
                            <div class="elementor-widget-container">
                                <h2 class="elementor-heading-title elementor-size-default">  Info@HorseStation.store
                                    <i style="" aria-hidden="true" class="far fa-envelope"></i>
                                </h2>
                            </div>
                        </div>
