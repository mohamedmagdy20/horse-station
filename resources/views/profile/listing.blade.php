                                                ...
                                                <div class="rtcl-MyAccount-mobile-navbar">
                                                    ...
                                                    <nav class="rtcl-MyAccount-navigation">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li
                                                                class="rtcl-MyAccount-navigation-link rtcl-MyAccount-navigation-link--listings is-active">
                                                                <a
                                                                            ...
                                                                            <div class="rtcl-ad-details">
                                                                                ...
                                                                                <ul class="rtcl-meta">
                                                                                    ...
                                                                                    <li>
                                                                                        ...
                                                                                        <a
                                                                                            href="https://codedhosting.com/alfuraij/listing-category/investment-properties/apartments/">{{app()->getLocale() === 'en' ? $item->category->name_en : $item->category->name_ar}}</a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <svg width="16"
                                                                                            height="12"
